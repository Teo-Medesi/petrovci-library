...
const Book = ({ book }: { book: Book }) => {
  return (
    <div className='cursor-pointer w-full lg:w-[128px] lg:min-h-[194px] flex flex-col items gap-2'>
      {
        book?.cover_image 
          ?
          <img className='rounded w-[128px] h-[194px]' src={book.cover_image} alt="cover image of book" />
          :
          <div className='rounded w-[128px] h-[194px] border border-gray-500 flex justify-center items-center'>no cover image</div>
      }
